...
class SetDataset:
    def __init__(self, crop_size, crop_num, min_scale_crops, max_scale_crops, data_path, num_class, batch_size):
        ...
        sub_data_loader_params = dict(batch_size = batch_size,
                                  ...
                                  pin_memory = False)        
        for cl in self.cl_list:
            sub_dataset = SubDataset(self.crop_size, self.crop_num, self.min_scale_crops, self.max_scale_crops, self.sub_meta[cl])
...
class Eposide_DataManager():
    def __init__(self, crop_size, crop_num, min_scale_crops, max_scale_crops, data_path, num_class, n_way=5, n_support=1, n_query=15, n_eposide=1):        
    ...
    def get_data_loader(self): 
        dataset = SetDataset(self.crop_size, self.crop_num, self.min_scale_crops, self.max_scale_crops, self.data_path, self.num_class, self.batch_size)
